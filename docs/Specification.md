...
| Status   | Draft. Phase 1 hardware layer in progress; board initialisation, settings persistence, and filtered/calibrated pot inputs implemented. Pot inputs GPIO32–35 are bench-verified; remaining ESP32 assignments remain proposed or unassigned. |
| Version  | 0.6                                               |
| Owner    | LeweeLewee                                        |
