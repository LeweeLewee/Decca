...
| Status   | Draft. Phase 1 hardware layer in progress; board initialisation, settings persistence, and filtered/calibrated pot inputs implemented. ESP32 pin assignments remain proposed, not bench-verified. |
| Version  | 0.5                                               |
| Owner    | LeweeLewee                                        |
