...
|------|-----|-------------------------------|-------|--------|
| WiiM Pro | 1 | **ACQUIRED / INSTALLED / API VERIFIED** | Delivered 2026-09-10 and commissioned on the live local API. EQ is off and the WiiM volume limit is set to 70%. ESP32 restores the digital path when VHF is latched and selects Line-In for Vinyl when VHF is released; phone controls digital content. Continuously powered with automatic standby. Do not substitute WiiM Amp / Amp Pro without a new ADR. | Amazon |
| Fosi Audio ZA3 | 1 | **ACQUIRED / INSTALLED** | Delivered 2026-09-10 with the 48 V / 5 A supply. WiiM Pro line output feeds the ZA3; its gain/volume becomes a commissioning ceiling and its operating state is controlled by the 12 V trigger. | Amazon |
| B&W DM601 S3 speakers | 2 | **ACQUIRED / MOUNTED / FIT VERIFIED** | Installed in the original speaker bays on spikes. The front ports and tweeters are aligned with openings in the retained speaker-cover construction; the surrounding bay air space is intentionally left unpacked. | Used purchase |
| ZA3 12 V trigger driver and source | 0 | **REMOVED — NOT REQUIRED** | Superseded by direct WiiM Pro trigger-out to ZA3 trigger-in connection under ADR-0018. The ESP32 is not electrically connected to the trigger. | n/a |
| WiiM-to-ZA3 trigger lead/adaptor | 1 | **INSTALLED / ACCEPTED** | Direct 2.5 mm-to-3.5 mm connection under ADR-0018. Thirty-second standby and switch-only wake passed; no ESP32 electrical connection to the 12 V line. | WiiM / Fosi |
| Stereo RCA interconnect | 1 | **ACQUIRED / ACCEPTED** | Supplied WiiM stereo RCA lead retained for the WiiM Pro line-output connection to the ZA3; no audiophile replacement is required unless a fault, interference or unsuitable final length is found. | Supplied with WiiM Pro |
| Turntable-to-WiiM analogue interconnect | 1 | **PURCHASED / DELIVERED / IN USE** | UGREEN RCA-to-3.5 mm stereo phono/mini-jack lead, 1 m, ASIN B015PZ7QO2. Connects the turntable analogue output to the WiiM Pro Line-In. Replacement cable ordered for £6.28 after the first example was returned as defective; delivered 2026-09-15. | Amazon / UGREEN |
| QED Profile 79 Strand speaker cable | 3 × 1 m | **PURCHASED / DELIVERED — TERMINATION / INSTALLATION CHECK** | Black 2 × 2.5 mm² OFC cable, model C-79/100B-1M. Three separate 1 m lengths purchased for the two short ZA3-to-speaker runs plus one spare; delivered 2026-09-16. Order total £6.30 with free postage. | eBay / Inta Audio |
| QED Screwloc Forte banana plugs | 4 | **PURCHASED / DELIVERED — INSTALLATION CHECK** | Gold-plated 4 mm Screwloc Forte plugs for amplifier/speaker binding posts; delivered 2026-09-18. Four plugs are sufficient to terminate one end of both stereo runs; the opposite ends remain bare wire unless four additional plugs are later purchased. | Amazon |
