...
| DAOKAI MOSFET driver modules | Pack of 10; 1 required | **DELIVERED / ELECTRICALLY VERIFIED** | ASIN B09YYH2BTF. One module passed GPIO25 safe-off, smooth PWM to a held 25% duty and return-to-off testing with the three-lamp load on 2026-08-31. Final installed current measurement remains open. | Amazon / DAOKAI |
