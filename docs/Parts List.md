...
|------|-----|-------------------------------|-------|--------|
| WiiM Pro | 1 | **LOCKED — ACQUIRED / NETWORK + METADATA VERIFIED** | Delivered and configured as Decca on 2026-09-11. Fixed local address is held only in installation configuration. Live HTTPS identity, idle player and active TIDAL metadata probes passed on firmware `Linkplay.4.8.827634`; source/volume commands, OTA and audio remain open gates. Continuously powered with automatic standby. | _Acquired_ |
