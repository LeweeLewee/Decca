...
| DFRobot Gravity MOSFET Power Controller | 1 | **INSTALLED — INITIAL FLICKER PASS / FULL ACCEPTANCE OPEN** | DFR0457; installed for final dial-lamp switching. The steady-light flicker fault is resolved. Firmware is now configured for 1 kHz and 85% / duty 217; fade, pot-stability, safe-off, temperature and current checks remain before closure. | The Pi Hut |
