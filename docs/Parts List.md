...
| 10 kΩ D18 control pull-down resistor | 1 | **REQUIRED — INSTALL WITH POWER OFF** | Connect from the DFR0457 control/PWM input (the same node as ESP32 GPIO18/D18) to common GND. Retain permanently to guarantee safe-off during ESP32 reset and high-impedance boot. | Existing stock / _TBD_ |
