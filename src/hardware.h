...
// GPIO32–35 and display GPIO21/22 are bench-verified.
// On/off GPIO14, VHF GPIO26 and Stereo/Mono GPIO19 are pending verification.
...
constexpr uint8_t kSwitchStereoMono = 19;
