...
replaced by a single continuous inset masking wall, 2.80 mm deep, around all
four sides and all four corners, on a controlled **0.10 mm per side horizontal
interference**. The wall is **1.25 mm on the sides** — thick enough for its
inner face to sit flush with the face opening, with no set-back — and
**0.80 mm top and bottom**, which holds the clear height. The two Rev N recessed adhesive pads are deleted at
...
Validation: **51/51 gates PASS** in Fusion and **44/44 PASS** in the independent
...
| | mm |
|---|---:|
| Bezel face opening, at the front face | **32.900 × 15.350** |
| Inset-wall outer / inner envelope | **35.400 × 15.200** / 32.900 × 13.600 (flush) |
...
| **Effective clear optical opening** | **32.900 × 13.600** |

> **Three things the prototype must settle, and CAD cannot.**
>
> 1. **The interference.** The wall is 0.10 mm per side wider than the hole, and
>    the wall resisting that is the **1.25 mm side** wall — about **31× stiffer
>    in bending** than the original 0.40 mm. Whether it flexes instead of
>    stressing the Perspex is physical. Print `Bezel_Fit_Gauge_revQ` first;
>    it is mandatory now, not advisable. Build report §8.1 and §3.6.
> 2. **Two continuous wall loops.** CAD proves the geometry admits them exactly;
>    only the production slicer preview can prove it lays them. Build report
>    §7.1 and §10 Stage 0b.
> 3. **The optical cost.** The clear opening is 32.90 × 13.60 and the visible
>    lit band drops 8.100 → **7.450 mm**, all at the top. A powered-test
>    decision, not a CAD result. Build report §5.

> **One forced modelling decision, declared.** The amended face opening (15.35)
> is taller than the whole wall (15.20), so a straight-walled aperture would
