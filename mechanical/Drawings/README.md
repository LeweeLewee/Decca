...
Validation: **46/46 gates PASS** in Fusion and **42/42 PASS** in the independent
...
>    at 0.80 mm, about **8× stiffer in bending** than the 0.40 mm wall it
>    replaces. Whether it flexes instead of stressing the Perspex is physical.
>    Print `Bezel_Fit_Gauge_revQ` first. Build report §8.1.
...
>    §7.1 and §10 Stage 0b.
> 3. **The optical cost.** The clear opening is 30.90 × 13.60 and the visible
